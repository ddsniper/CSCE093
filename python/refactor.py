...
#([A-Z0-9a-z]*)_([A-Z0-9a-z\s]*)_*([A-Z0-9a-z]*).?([A-Z0-9a-z]*)
...
def RegExsub(fileContents, expression) :
    regExp = re.match(expression, fileContents.readline)
    return regExp
